...
public class WeiboExtractBuilder extends AbsTSquidBuilder implements TSquidBuilder {

	public WeiboExtractBuilder(BuilderContext ctx, Squid currentSquid) {
	...
	public List<TSquid> doTranslate(Squid cur) {
		// 现在默认为数据库抽取
		WeiBoExtractSquid extractSquid = (WeiBoExtractSquid) cur;
		...
		dataSource.setTableName("ds_spider.ED_SINA_WEIBO");
...
//		dataSource.setPort(ConfigurationUtil.getInnerHbasePort());
	...
	public void setFilter(WeiBoExtractSquid extractSquid, TDataSource tds) {

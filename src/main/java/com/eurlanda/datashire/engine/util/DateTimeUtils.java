...
final public class DateTimeUtils {
    final static public String DateFormater_pattern = "yyyy-MM-dd";

    final static public String TimeFormater_pattern = "HH:mm:ss";

    final static public String DateTimeFormater_pattern = "yyyy-MM-dd HH:mm:ss";
...
//		return DateFormater.format(new Date());
		return DateUtil.format(DateFormater_pattern, new Date());
	}
...
//		return TimeFormater.format(new Date());
		return DateUtil.format(TimeFormater_pattern, new Date());
	}
...
//		return DateTimeFormater.format(new Date());
		return DateUtil.format(DateTimeFormater_pattern, new Date());
	}
	...
	static public String currentDateTime(String format) {
		try {
			return DateUtil.format(format, new Date());
		} catch (Exception ex) {
...
//			return DateTimeFormater.format(date);
			return DateUtil.format(DateTimeFormater_pattern, date);
		else
			return null;
	}
	...
	static public String customDateTime(Date time, String format) {
		try {
			return DateUtil.format(format, time);
		} catch (Exception ex) {
			throw new RuntimeException("no exsits formater: " + format, ex);
		}
	}
	...
	static public Date parserDateTime(String datetime) {
		try {
			return DateUtil.parse(DateTimeFormater_pattern, datetime);
	...
	static public Date parserDateTime(String datetime, String format) {
		try {
			return DateUtil.parse(format, datetime);
		} catch (Exception ex) {

...
-- CREATE INDEX SYS_IDX_SYS_CT_10389_10400 ON DS_SQUID (NAME ASC, SQUID_FLOW_ID ASC);
...
(ID INTEGER NOT NULL AUTO_INCREMENT,
 ...
 COLUMN_ID1 INTEGER,
  PRIMARY KEY (ID));
-- CREATE INDEX SYS_IDX_SYS_CT_10296_10301 ON DS_INDEXES (INDEX_NAME ASC, SQUID_ID ASC);
...
(ID INTEGER NOT NULL AUTO_INCREMENT,
 ...
 DESCRIPTION VARCHAR(500),
  PRIMARY KEY (ID));
INSERT INTO DS_JOIN_TYPE (ID,CODE,DESCRIPTION)VALUES(1,0,'BASETABLE');
INSERT INTO DS_JOIN_TYPE (ID,CODE,DESCRIPTION)VALUES(2,1,'INNERJOIN');
INSERT INTO  DS_JOIN_TYPE (ID,CODE,DESCRIPTION)VALUES(3,2,'LEFTOUTERJOIN');
INSERT INTO  DS_JOIN_TYPE  (ID,CODE,DESCRIPTION)VALUES(4,3,'RIGHTOUTERJOIN');
INSERT INTO  DS_JOIN_TYPE  (ID,CODE,DESCRIPTION)VALUES(5,4,'FULLJOIN');
INSERT INTO  DS_JOIN_TYPE  (ID,CODE,DESCRIPTION)VALUES(6,5,'CROSSJOIN');
INSERT INTO  DS_JOIN_TYPE  (ID,CODE,DESCRIPTION)VALUES(7,6,'UNOIN');
INSERT INTO  DS_JOIN_TYPE  (ID,CODE,DESCRIPTION)VALUES(8,7,'UNOINALL');
...
(ID INTEGER NOT NULL AUTO_INCREMENT,
 ...
 CREATOR VARCHAR(50),
  PRIMARY KEY (ID));
-- CREATE INDEX SYS_IDX_SYS_CT_10323_10327 ON DS_PROJECT (NAME ASC, REPOSITORY_ID ASC);
...
-- CREATE INDEX SYS_IDX_SYS_CT_10350_10356 ON DS_SOURCE_COLUMN (SOURCE_TABLE_ID ASC, NAME ASC);
...
-- CREATE INDEX SYS_IDX_SYS_CT_10361_10366 ON DS_SOURCE_TABLE (TABLE_NAME ASC, SOURCE_SQUID_ID ASC);
...
-- CREATE INDEX SYS_IDX_SYS_CT_10405_10410 ON DS_SQUID_FLOW (NAME ASC, PROJECT_ID ASC);
...
(ID INTEGER NOT NULL AUTO_INCREMENT,
 ...
 LINK_TYPE INTEGER,
  PRIMARY KEY (ID));
CREATE INDEX SYS_IDX_SYS_CT_10417_10422 ON DS_SQUID_LINK (FROM_SQUID_ID ASC, TO_SQUID_ID ASC);
...
CREATE INDEX SYS_IDX_UNIQUE_GROUP_NAME_IN_TEAM_10127 ON DS_SYS_GROUP (NAME ASC, TEAM_ID ASC);
...
CREATE INDEX SYS_IDX_UNIQUE_REPOSITORY_NAME_IN_TEAM_10110 ON DS_SYS_REPOSITORY (TEAM_ID ASC, NAME ASC);
...
CREATE INDEX SYS_IDX_UNIQUE_ROLE_NAME_IN_GROUP_10138 ON DS_SYS_ROLE (NAME ASC, GROUP_ID ASC);
...
CREATE INDEX SYS_IDX_SYS_PK_10242_10243 ON DS_SYS_SF_JOB_MODULE_LOG (TASK_ID ASC, SQUID_ID ASC);
...
INSERT INTO ds_sys_server_parameter (ID, NAME, VALUE, DATA_TYPE, IS_COLLECTION) VALUES (4, 'LimitedTime', 'vLPjgyyQhFaKop/YzzdtXg==', 'N', 'N');
...
INSERT INTO ds_transformation_type (ID, CODE, OUTPUT_DATA_TYPE, DESCRIPTION) VALUES (76, 'INVERSEQUANTIFY', 21, '把基于dm squid model的predict输出，反推得到原始的标签值');
